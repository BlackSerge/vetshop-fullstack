...
import { 
  Sun, Moon, ShoppingCart, User, LogOut,
...
export default function Header() {
  ...
  const { user, isAuthenticated, logout, isStaff } = useAuthStore() as any;
  const cartCount = useCartStore((state: any) => state.count);
  const isAnimating = useCartStore((state: any) => state.isAnimating);
