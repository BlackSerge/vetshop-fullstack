...
import { 
    ArrowLeft, User, Shield, Clock, MapPin, 
    ShoppingBag, DollarSign, Calendar, Package 
} from 'lucide-react'; 
import adminService from '../services/adminService';
import { LoadingSpinner, useThemeStore } from '@/shared';
import type { AdminUserDetail, Order } from '../types';
...
export default function AdminUserDetailPage(): JSX.Element {
  ...
  if (!user) return <div className="p-6 text-center text-red-500">Error al cargar usuario</div>;
