...
export default function AdminCategoriesPage(): JSX.Element {
  ...
  const handleDeleteClick = (category: Categoria): void => {
  ...
  const renderActions = (row: Record<string, any>): JSX.Element => {
    const category = row as Categoria;
    return (
    <div className="flex gap-2 justify-end">
        <button 
          onClick={() => navigate(`/admin-panel/categorias/edit/${category.slug}`)}
