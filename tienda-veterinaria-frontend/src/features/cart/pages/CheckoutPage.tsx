...
import SkeletonLoader from "../../products/components/ProductCardSkeleton";
...
export default function CheckoutPage() {
  ...
  const { clientSecret, error, fetchPaymentIntent } = usePaymentIntent(cartId, cartItems.length);
