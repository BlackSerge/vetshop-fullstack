...
Vistas (controllers) delgadas que manejan solo el ruteo HTTP y la validación.
...
def _merge_anonymous_cart(request, user: CustomUser) -> Optional[dict]:
    """
    Fusiona un carrito anónimo con el carrito del usuario autenticado.
    
    Args:
        request: HttpRequest
        user: CustomUser autenticado
        
    Returns:
        Dict con datos del carrito fusionado o None
    """
...
class CustomTokenObtainPairView(TokenObtainPairView):
    """
    Login personalizado que incluye:
    - Tokens JWT
    - Datos del usuario
...
class UserAdminListAPIView(generics.ListCreateAPIView):
    """Administración: lista todos los usuarios."""
...
class UserAdminRetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView):
    """Administración: detalle, edición y eliminación de usuarios."""
