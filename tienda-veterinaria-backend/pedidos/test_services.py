...
Test suite para pedidos/services.py (OrderService y PaymentService)
Usando pytest con fixtures Django.
"""
...
# ==============================================================================
# TESTS: OrderService.validate_shipping_address
# ==============================================================================
...
def test_validate_shipping_address_missing_field():
    """✓ Lanza excepción si falta un campo."""
...
# ==============================================================================
# TESTS: OrderService.extract_shipping_from_payment_intent
# ==============================================================================


@pytest.mark.django_db
def test_extract_shipping_from_intent_with_shipping_data():
    """✓ Extrae datos de "shipping" en PaymentIntent."""
    intent = {
        "id": "pi_test",
        "shipping": {
            "name": "John Doe",
...
def test_extract_shipping_from_intent_fallback_to_charges():
    """✓ Fallback a 'charges' billing si 'shipping' no está."""
    intent = {
        "id": "pi_test",
        "receipt_email": "john@example.com",
        "charges": {
...
# ==============================================================================
# TESTS: OrderService.create_order_from_payment (TRANSACCIÓN ATÓMICA)
# ==============================================================================


@pytest.mark.django_db
def test_create_order_from_payment_success(test_user, test_cart, test_product):
    """✓ Crea orden exitosamente desde un pago."""
    payment_intent = {
...
def test_create_order_from_payment_duplicate_prevention(test_user, test_cart, test_product):
    """✓ Previene crear órdenes duplicadas para el mismo payment_intent."""
    payment_intent = {
...
def test_create_order_empty_cart(test_user, test_product):
    """✓ Lanza excepción si el carrito está vacío."""
...
# ==============================================================================
# TESTS: OrderService._check_vip_upgrade
# ==============================================================================


@pytest.mark.django_db
def test_vip_upgrade_automatic(test_user, test_cart, test_product):
    """✓ Asciende a VIP automáticamente cuando supera umbral."""
    # Crear carrito con producto que cuesta $1000 (supera VIP_THRESHOLD de $500)
    ...
    # Usuario no es VIP inicialmente
...
# ==============================================================================
# TESTS: OrderService.update_order_status
# ==============================================================================


@pytest.mark.django_db
def test_update_order_status_success(test_user, test_cart):
    """✓ Actualiza status de orden correctamente."""
...
# ==============================================================================
# TESTS: OrderService.cancel_order
# ==============================================================================
...
def test_cancel_order_not_pending(test_user):
    """✓ No permite cancelar una orden que no está PENDING."""
    order = Order.objects.create(
        user=test_user,
        full_name="John Doe",
        email="john@example.com",
...
# ==============================================================================
# TESTS: PaymentService.validate_webhook_signature
# ==============================================================================


@pytest.mark.django_db
def test_verify_webhook_signature_invalid():
    """✓ Rechaza firma de webhook inválida."""
