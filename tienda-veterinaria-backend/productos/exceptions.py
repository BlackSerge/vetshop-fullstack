"""
productos/exceptions.py

Excepciones personalizadas para la capa de servicios de productos.
"""


class ProductServiceError(Exception):
    """Excepción base para errores en el servicio de productos."""
...
class DuplicateReviewError(ProductServiceError):
    """El usuario ya ha calificado este producto."""
...
class InvalidRatingError(ProductServiceError):
    """Calificación inválida (debe estar entre 1 y 5)."""
