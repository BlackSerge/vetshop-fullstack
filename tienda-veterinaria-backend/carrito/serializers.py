...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    # Usamos product_id para recibir el ID del producto al añadir/actualizar
...
class CartSerializer(serializers.ModelSerializer):
    ...
    session_key = serializers.UUIDField(read_only=True) # <--- Ahora es de solo lectura, se genera/usa internamente

    class Meta:
        model = Cart
        fields = ['id', 'user', 'session_key', 'items', 'total_price', 'created_at', 'updated_at'] # <--- Incluye session_key
